            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/product/update">表</a>
                        </li>
                        <li class="separator">
                            <i class="flaticon-right-arrow"></i>
                        </li>
                    ...
                    <div class="col-md-6">
                        <div class="card" style="width: 980px;padding-left: 110px;padding-right: 100px">
                            <div class="card-header">
                                <div class="card-title" style="letter-spacing: 2px">修改信息</div>
                            </div>
                            <div class="card-body">
                                <form method="post" action="${pageContext.request.contextPath}/product/update">
                                    <div class="form-group">
                                        <input value="${proInfo.id}" name="id" type="hidden">
                                        <div class="form-group form-floating-label">
                                            <input id="inputFloatingLabel" type="text"
                                                   class="form-control input-border-bottom"
                                                   name="proName" value="${proInfo.proName}"
                                                   required>
                                            <label for="inputFloatingLabel" class="placeholder">产品名称</label>
                                        </div>
                                        <div class="form-group">
                                            <label for="comment"  class="placeholder">产品信息</label>
                                            <textarea name="proInfo" class="form-control" id="comment" rows="2"
                                                      required>${proInfo.proInfo}</textarea>
                                        </div>
                                        <div class="form-group form-floating-label" style="padding-top: 20px">
                                            <select class="form-control input-border-bottom selectType"
                                                    id="selectFloatingLabel" style="height: 42px;width: 330px"
                                                    name="proType" required>
                                                <option value=" ">&nbsp;</option>
                                            </select>
                                            <label for="selectFloatingLabel" class="placeholder" style="padding-top: 20px">请选择修改类型...</label>
                                        </div>
                                        <div class="card-action" style="padding-left: 200px">
                                            <input type="submit" class="btn btn-success" value="提交"
                                                   style="margin-right: 50px;width: 100px;letter-spacing: 5px"/>
                                            <a class="btn btn-danger" style="width: 100px;letter-spacing: 5px" href="${pageContext.request.contextPath}/company/mainInfo">返回</a>
                                        </div>
                                    </div>
                                </form>
                            </div>

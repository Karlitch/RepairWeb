		...
		<div class="container container-login animated fadeIn">
			...
			<div class="login-form">
				<div class="form-group form-floating-label">
					<input id="username" style="text-indent: 1em"  name="username" type="text" class="form-control input-border-bottom" required>
					<label for="username" class="placeholder">Username</label>
				</div>
				<div class="form-group form-floating-label">
					<input id="password" style="text-indent: 1em"  name="password" type="password" class="form-control input-border-bottom" required>
				...
				<div class="row form-sub m-0">
					<div class="custom-control custom-checkbox">
						<input type="checkbox" style="text-indent: 1em"  class="custom-control-input" id="rememberme">
